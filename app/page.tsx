  ...
  return (
    <main id="top">
      <header className="site-header">
        ...
        <nav aria-label="Main navigation"><a href="/how-it-works">How it works</a><a href="/gallery">Gallery</a><a href="/library">Library</a></nav>
      ...
      <section className="hero">
        ...
        <div className="hero-copy">
          <h1>Turn a walk<br />into a <span>one-of-one</span> art print.</h1>
          <p>Your path stays at the heart of it—shaped by its turns, loops, pauses, and pace into something personal you can keep.</p>
        ...
        <div className="hero-stats" aria-label="Sample walk summary">
          <div><span>Distance</span><strong>5.23 mi</strong></div>
          <div><span>Elevation</span><strong>+407 ft</strong></div>
          <div><span>Duration</span><strong>01:47:18</strong></div>
          <div><span>Location</span><strong>Brooklyn, NY</strong></div>
        </div>
        <div className="map-scale" aria-hidden="true"><i /><span>1 mi</span></div>
        <p className="coordinates">40.6782° N · 73.9442° W</p>
      </section>

      <section className="intro">
        <p className="section-kicker">A walk, made visible</p>
        <h2>Your route is more than a line.<br />It is a record of <span>how you moved.</span></h2>
        <p className="intro-copy">Meander preserves the direction and rhythm of a walk, then lets its movement expand into color, texture, and flowing structure.</p>
      </section>
      ...
      <section className="process-preview" id="how-it-works">
        ...
        <div className="process-preview-rail" aria-label="Route to artwork process">
          ...
          <article><span>04</span><h3>Keep it your way</h3><p>Save privately, share by link, publish, or download.</p></article>
        </div>
      ...
      <section className="gallery" id="gallery">
        <div className="section-top"><div><p className="section-kicker">A few ways movement can look</p><h2>Three walks.<br />Three distinct fields.</h2></div><p>Each piece begins with a real route, then keeps its own direction and rhythm.</p></div>
      ...
      <footer><a className="brand" href="#top"><BrandMark />Meander</a><p>The geometry of going somewhere.</p><div><a href="/how-it-works">Process</a><a href="/gallery">Gallery</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a><a href="/copyright">Copyright</a></div><small>© 2026 MEANDER · RAW ROUTES STAY PRIVATE</small></footer>
    </main>
  );
}
