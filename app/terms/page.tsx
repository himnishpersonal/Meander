...
export default function TermsPage() {
  return <main className="legal-page"><header className="site-header"><Link className="brand" href="/"><span className="brand-line" />Meander</Link><nav aria-label="Main navigation"><Link href="/how-it-works">How Meander works</Link><Link href="/privacy">Privacy</Link></nav><AccountNav /></header>
    <section className="legal-hero"><p className="section-kicker">Terms of use</p><h1>Create with care.<br /><span>Share by choice.</span></h1><p>These terms explain the rules for using Meander’s route-to-art creation service.</p><small>Effective date: August 20, 2026 · Meander is operated by Himnish Sambaraju in the United States.</small></section>
    <section className="legal-content"><article><h2>Using Meander</h2><p>Meander is a creative tool, not a navigation, fitness, emergency, or safety service. Do not rely on it for route guidance or decisions that could affect safety. You must be at least 16 years old, or the age of digital consent where you live, to create an account.</p></article>
      ...
      <article><h2>Availability and changes</h2><p>Meander is an independent side project operated by Himnish Sambaraju in the United States. Features may change, pause, or be removed, especially during beta. To the extent allowed by law, the service is provided as available. Questions about these terms can be sent to <a href="mailto:himnish03@gmail.com">himnish03@gmail.com</a>.</p></article>
