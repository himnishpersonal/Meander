...
export default function SharedArtwork({ params }: { params: Promise<{ shareId: string }> }) {
  ...
  return <main className="share-page">
    <header className="site-header"><Link className="brand" href="/"><BrandMark />Meander</Link><Link className="nav-cta" href="/create">Make your own <span>↗</span></Link></header>
